...
const Footer = () => {
    return (
        <footer class="text-center lg:text-left bg-gray-200 text-gray-600 text-lg">
            ...
            <div class="mx-6 py-10 text-center md:text-left">
                <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-10">
                    <div class="px-4">
                        <h6 class="
                            uppercase
                            font-semibold
                    ...
                    <div class="px-4">
                        ...
                        <p class="mb-4">
                            <a href="#!" class="text-gray-600">Terms of Services</a>
                        </p>
                        <p>
            ...
            <div class="text-center p-6 bg-gray-200">
                <span>© Copyright:</span>
                <a class="text-gray-600 font-semibold" href="#">Tikhalwale</a>
            </div>
        </footer>
    )
}
