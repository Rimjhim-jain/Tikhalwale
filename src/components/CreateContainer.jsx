    ...
    <div className='w-full min-h-screen flex items-center justify-center'>
      <div className='w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4'>
        ...
        <div className='w-full py-2 border-b border-gray-300 flex items-center gap-2'>
          <MdFastfood className='text-xl text-grau-700 ' />
          <input
            type="text"
            required
            value={title}
            ...
            {!imageAsset ? <>
              ...
              <>
                <div className='relative h-full'>
                  ...
                  <button type='button' className='absolute bottom-3 right-3 p-3 rounded-full bg-red-500 text-xl cursor-pointer outlinr-none hover:shadow-md duration-500 transition-all ease-in-out'
                    onClick={deleteImage}
        ...
        <div className='w-full flex flex-col md:flex-row items-center gap-3'>
          ...
          <div className='w-full py-2 border-b border-gray-300 flex items-center gap-2'>
            ...
            <input type="text" required
              ...
              placeholder='Price' className='w-full h-full text-lg bg-transparent outline-none border-none placeholder:text-gray-400 text-textColor' />
          </div>
        </div>
